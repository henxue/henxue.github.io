...
$ecms_config['db']['dbname']='github_henxue';	//数据库名
...
//后台安全设置
$ecms_config['esafe']['loginauth']='hongrongshun';	//登录认证码,如果设置登录需要输入此认证码才能通过
$ecms_config['esafe']['ecookiernd']='rrrrrrrrrrrrrrrrrrrrrrrrrrrrrr';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='ppppp';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='ppppp';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='rrrrrrrrrrrrrrrrrrrrrrrrrrrrrr';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='rrrrEEEEEEEEEEEEEEEEEEEEEEEEEE';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'nnnnnnnnnnnnnnnnnnnnnnnnnnnnnn',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/tutorials/\">帝国教程</a>&nbsp;|&nbsp;<a href=\"/template/\">帝国模版</a>&nbsp;|&nbsp;<a href=\"/plug/\">插件模块</a>&nbsp;|&nbsp;<a href=\"/news/\">业界新闻</a>&nbsp;|&nbsp;<a href=\"/website/\">建站相关</a>&nbsp;|&nbsp;<a href=\"/design/\">前端设计</a>&nbsp;|&nbsp;<a href=\"/lnmpa/\">LNMPA</a>&nbsp;|&nbsp;<a href=\"/seo/\">SEO</a>&nbsp;|&nbsp;<a href=\"/blog/\">网络日志</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'memberconnectnum'=>0,
'closehmenu'=>'',
'deftempid'=>0,'add_seotitle'=>'专注帝国CMS网站建设及模版制作 | www.henxue.net');
//------------e_public
